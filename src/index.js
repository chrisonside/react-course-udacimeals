...
ReactDOM.render(
  ...
  // whenever any of the components that App renders, or whenever App itself needs access to Redux store or needs to dispatch an action, it can more easily do that
